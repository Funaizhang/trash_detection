...
pcl::PointCloud<pcl::PointXYZRGBA>::Ptr tmp_cloud;         
...
public:
      ...
      nh("~"), spinner(0), it(nh), mode(CLOUD)
  {
    ...
    params.push_back(0);
    //std::cout << color->cols << "test calss" << std::endl;
  }
...
private:
  void start(const Mode mode)
  {
    ...
    std::cout << "test rgb:" << color.cols<< std::endl;  
    ...
    std::cout << "test:" << cloud->height<< cloud->width << std::endl;  
  ...
  void cloudViewer()
  {
    ...
    createCloud(depth, color, cloud);
    std::cout << depth.rows << "cols " << depth.cols << std::endl;
    std::cout << color.rows << "cols " << color.cols << std::endl;
    ...
    visualizer->setPosition(mode == BOTH ? depth.rows : 0, 0);
    visualizer->setPosition(100, 10);
 ...
 //gd add 
  ...
  {
    oss.str("");
    oss << "/home/dex_hand/Documents/yc_data/deepgrasp/kinect_data/" 
    ...
    OUT_INFO("saving depthandcolor: " << depthColoredName);
